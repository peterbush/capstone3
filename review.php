...
<body>
       <style>
		...
		background: linear-gradient(#d8e5f3, #a3c1e2, #d8e5f3);
		}
	...
	<div class="container">
		...
		<table class="table table-bordered table-striped">
			...
			<tbody id="appTable">
				<?php
				$sql = "SELECT DAYNAME(subdate) as day, MONTHNAME(subdate) as month, DAY(subdate) as date, YEAR(subdate) as 				year, id, firstname, lastname, email, number, street, city, state, zip, department, perhour, 
